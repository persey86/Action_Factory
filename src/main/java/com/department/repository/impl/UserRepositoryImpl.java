...
public class UserRepositoryImpl implements UserRepository {
    ...
    public static final String SELECT_FROM_USERS_IS_ANY_BUT_NOT_ME = "SELECT count(*) as total from users  where users.id <> ? and users.email = ?";
    public static final String SELECT_FROM_USERS_IS_ANY = "SELECT count(*) as total from users where users.email = ?";

    public static final String SELECT_FROM_USERS_WHERE_DEP_id = "SELECT * from users u where u.department_id = ?";
    public static final String INSERT_INTO_USERS = "INSERT INTO users (name,surname,email,created,age,department_id) VALUES (?,?,?,?,?,?)";

    public static final String UPDATE_USER = "UPDATE users SET name = ?, surname = ?, email = ?, created = ?, age = ?, department_id =?  WHERE id = ?";
    ...
    // we use this when create user to check name uniq
    @Override
