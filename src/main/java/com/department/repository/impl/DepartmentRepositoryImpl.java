...
public class DepartmentRepositoryImpl implements DepartmentRepository{
    ...
    public static final String SELECT_FROM_DEPARTMENTS_IS_ANY_BUT_NOT_ME = "SELECT count(*) as total from departments  where departments.id <> ? and departments.name = ?";
    public static final String SELECT_FROM_DEPARTMENTS_IS_ANY = "SELECT count(*) as total from departments where departments.name = ?";
    public static final String SELECT_FROM_DEPARTMENTS = "SELECT * from departments d ";
    public static final String INSERT_INTO_DEPARTMENTS = "INSERT INTO departments (name, created) VALUES (?, ?)";
    public static final String UPDATE_DEPARTMENT = "UPDATE departments SET name = ?, created = ? WHERE id = ?";
    public static final String DELETE_DEPARTMENTS = "DELETE FROM departments WHERE id = ?";
    public static final String GET_DEPARTMENT_WITH_SELECTED_id = "SELECT * from departments where departments.id = ?";
    ...
    public List<Department> findAll() throws DepartmentRepositoryException {
        ...
        try (Connection connection = getConnection()) {
            ...
            PreparedStatement pStm = connection.prepareStatement(SELECT_FROM_DEPARTMENTS);
