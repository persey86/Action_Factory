...
<div class="main container">
        ...
        <table class="table table-bordered">
            <c:forEach var="department" items="${allDepartments}">
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="/editDepartment?departmentId=${department.id}">Edit</a></td>
                    <td>
    ...
    <div class="row">
        <form method="post" action="<c:url value='/createDepartment' />">
            <input type="text" placeholder="Name" name="departmentName" value="${departmentName}"/>
